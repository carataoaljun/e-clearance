        ...
        @if (! $__env->hasSection('hide-page-header'))
            @php
                ...
                $portalPageMeta = match (true) {
                    ...
                    request()->routeIs('student.chat-support') => ['eyebrow' => 'Student Support', 'icon' => 'bi bi-chat-square-text-fill', 'description' => 'Message your assigned instructors and get help with clearance concerns.'],
